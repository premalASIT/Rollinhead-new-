...
import 'package:rollinhead/Model/storyuploada/UploadStoryApi.dart';
import 'package:rollinhead/feedspage.dart';
import 'package:rollinhead/homepage.dart';
import 'package:rollinhead/modules/all_emojies.dart';
import 'package:rollinhead/modules/bottombar_container.dart';
import 'package:rollinhead/modules/colors_picker.dart';
import 'package:rollinhead/modules/emoji.dart';
import 'package:rollinhead/modules/text.dart';
import 'package:rollinhead/modules/textview.dart';
...
class _ImageEditorProState extends State<ImageEditorPro> {
  ...
  Future uploadStoryMedia(File fileimage,String Msg,Loc) async {
    ...
    http.MultipartRequest('POST', Uri.parse("http://rolinhead.dolphinfiresafety.com/registration/createStory"));

    final vfile = await http.MultipartFile.fromPath('imagefile', fileimage.path,
  ...
  //video
  Future uploadStoryVideo(File fileimage,String Msg,Loc) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final mimeTypeData =
    lookupMimeType(fileimage.path, headerBytes: [0xFF, 0xD8]).split('/');
    final imageUploadRequest =
            ...
            new FlatButton(
                ...
                onPressed: () {
                  ...
                  screenshotController
                    ...
                    print(paths.path + '/' + DateTime.now().millisecondsSinceEpoch.toString() + '.png');
                    uploadStoryMedia(image," "," ");
