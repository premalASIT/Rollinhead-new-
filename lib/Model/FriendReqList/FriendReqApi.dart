import 'package:rollinhead/Model/FriendReqList/status.dart';
import 'package:rollinhead/Model/FriendReqList/response.dart';
...
class FriendReqApi {
  ...
  final List<Response> response;
	...
	FriendReqApi.fromJsonMap(Map<String, dynamic> map): 
