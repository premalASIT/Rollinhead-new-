...
class _FollowersPageState extends State<FollowersPage> {
  ...
  FollowersListApi friendlist;
  Future<List<dynamic>> fetchFriendList() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String userid =prefs.getString('user_Id');
    final response = await http.get(
      'http://rolinhead.dolphinfiresafety.com/registration/followersList?userId=$userid',
    );
    friendlist= new FollowersListApi.fromJsonMap(json.decode(response.body.toString()));
